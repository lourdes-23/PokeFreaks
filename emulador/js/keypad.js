function GameBoyAdvanceKeypad() {
	this.KEYCODE_UP = 87;       // W
	this.KEYCODE_LEFT = 65;     // A
	this.KEYCODE_DOWN = 83;     // S
	this.KEYCODE_RIGHT = 68;    // D
	this.KEYCODE_A = 81;        // Q
	this.KEYCODE_B = 69;        // E
	this.KEYCODE_START = 13;    // Enter
	this.KEYCODE_SELECT = 16;   // Shift
	this.KEYCODE_L = 90;        // Z (opcional)
	this.KEYCODE_R = 88;        // X (opcional)
